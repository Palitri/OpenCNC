                ...
                for (int d = this.rulerDivisionFactors.Length - 1; d >= 0; d--)
                {
                    if (this.IsMultipleOf(divisionX, this.rulerDivisionFactors[d] / divisionsZoomFactor))
                    {
                        ...
                        if (this.rulerDivisionFonts[d] != null)
                        {
                            ...
                            if (isZero)
                                this.horizontalStripGraphics.FillRectangle(new SolidBrush(this.zeroBackColor), x - 1, y, textLength + 2, 14);
                ...
                for (int d = this.rulerDivisionFactors.Length - 1; d >= 0; d--)
                {
                    if (this.IsMultipleOf(divisionY, this.rulerDivisionFactors[d] / divisionsZoomFactor))
                    {
                        ...
                        if (this.rulerDivisionFonts[d] != null)
                        {
                            ...
                            if (isZero)
                                this.verticalStripGraphics.FillRectangle(new SolidBrush(this.zeroBackColor), x - 14, this.mainScreenHeight - y - textLength - 2, 14, textLength + 2);

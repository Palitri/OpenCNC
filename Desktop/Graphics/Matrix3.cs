...
namespace Palitri.Graphics
{
    public class Matrix3
    {
        ...
        public Vector2 TransformDimensions(Vector2 point)
        {
            return this.TransformDimensions(point.x, point.y);
        }

        public Vector2 TransformDimensions(float x, float y)
        {
            Vector2 result = new Vector2();
        ...
        public static void Copy(Matrix3 result, Matrix3 source)
        {
        ...
        public static void Multiply(Matrix3 result, Matrix3 matrix1, Matrix3 matrix2)
        {
        ...
        public static void CreateViewport(Matrix3 result, float x, float y, float width, float height)
        {
        ...
        public static void CreatePlot(Matrix3 result, float x, float y, float width, float height)
        {
            result.m11 = width;
            result.m12 = 0.0f;
            result.m13 = 0.0f;
        ...
        public static void CreatePlot(Matrix3 result, float x, float y, float width, float height, float angle)
        {
        ...
        public static void CreateTranslation(Matrix3 result, float x, float y)
        {
            result.m11 = 1.0f;
            result.m12 = 0.0f;
            result.m13 = 0.0f;
        ...
        public static void CreateSkewX(Matrix3 result, float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
        ...
        public static void CreateSkewY(Matrix3 result, float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
            float tg = cos != 0 ? sin / cos : 0.0f;
        ...
        public static void CreateScale(Matrix3 result, float x, float y)
        {
            result.m11 = x;
            result.m12 = 0.0f;
            result.m13 = 0.0f;
        ...
        public static void CreateRotation(Matrix3 result, float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
            result.m11 = cos;

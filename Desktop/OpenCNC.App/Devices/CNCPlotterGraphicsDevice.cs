...
namespace OpenCNC.App
{
    ...
    public class CNCPlotterGraphicsDevice : IGraphicsDevice
    {
        ...
        public CNCPlotterGraphicsDevice(ICNC cnc, OpenCNCAppSettings settings)
        {
            this.cnc = cnc;
        ...
        {
            this.cnc.Begin();
            this.IssueMove(new Vector2(this.origin.X, this.origin.Y));
            this.cnc.End();
            this.cnc.Execute();
        }
        ...
        public static CNCVector SVGToCNCDimensions(Vector2 dimensions, float z = 0.0f)
        {
